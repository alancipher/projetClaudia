...
var ante = new SimpleSchema({
    ...
    q10: {
        type: question1,
        label: 'Antécédents familiaux (lorsque pertinent; par exemple si ATCD de néoplasie)',
...
// surgery schema
var Chirurgies = new SimpleSchema({
    owner: {
        type: String,
