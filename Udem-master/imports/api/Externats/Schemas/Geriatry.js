...
var social = new SimpleSchema({
    ...
    q4: {
        type: question1,
        label: 'Services à domicile (infirmiers, aidants, service alimentaire..',
...
var domestic = new SimpleSchema({
    ...
    q7: {
        type: question1,
        label: 'Auto-médication',

        optional: true
    },
    q8: {
        type: question1,
        label: 'Transport (autre que la marche)',
