...
// Obstétriques
var obstetrique = new SimpleSchema({
    q1: {
        type: question1,
        label: 'ITSS',
...
var hga = new SimpleSchema({
    ...
    q5: {
        type: question1,
        label: 'Analyse et culture d’urine',

    },
    q6: {
        type: question1,
        label: 'Électrophorèse hémoglobine (si indiquée)',

    },
    q7: {
        type: question1,
        label: 'DPNQT21 (si fait)',
    ...
    q11: {
        type: question1,
        label: 'Hyperglycémie orale provoquée',
    ...
    q17: {
        type: question1,
        label: 'Indication de l’échographie du 3e trimestre',

    },
    q18: {
        type: question1,
        label: 'Estimé du poids foetal',

    },
    q19: {
        type: question1,
        label: 'Index du liquide amniotique',

    },
    q20: {
        type: question1,
        label: 'Anomalie doppler',
...
var alwaysAsk = new SimpleSchema({
    q1: {
        type: question1,
        label: 'Perte liquidienne (indiquer l’heure si possible)',

        optional: true
    },
    q2: {
        type: question1,
        label: 'Perte sanguines',
    ...
    q10: {
        type: question1,
        label: 'Scotomes visuels',

        optional: true
    },
    q11: {
        type: question1,
        label: 'Oedème des membres inférieurs aiguë',
...
var Gynecos = new SimpleSchema({
    ...
    type: {
        ...
        defaultValue: "Gynecologie et obstétrique",
        uniforms: {
            component: () => null // that's ok!
        },
    },
