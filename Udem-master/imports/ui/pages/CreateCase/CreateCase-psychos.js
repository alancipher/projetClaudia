...
import Surgeries from "../../../api/Externats/Schemas/Psychos";
  ...
  render() {
    ...
    return (
      <div className="CreateCase" className={classes.root}>
        ...
        >
          {" "}
          Créer un cas d'externat : Psychiatrie
        </Typography>
        <AutoForm
          schema={Psychos}
          onSubmit={doc => {
            ...
            console.log(doc);
            Meteor.call("externatsPsychiatry.insert", doc,"Psychiatrie", error => {
              if (error) {
    ...
    case 1:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <AutoField name="antecedents.q1.text" label={'Personnels médicaux'}  helperText="Ne pas utiliser d'acronymes" multiline />
          <AutoField name="antecedents.q1.important" />
          <AutoField name="antecedents.q1.value" />
          </div>
          <div style={styles.field}>
          <AutoField name="antecedents.q2.text" label={'Chirurgicaux'} multiline />
          <AutoField name="antecedents.q2.important"  />
          <AutoField name="antecedents.q2.value" />
          </div>
          <div style={styles.field}>
          <AutoField name="antecedents.q3.text" label={'Psychiatriques/psychologiques'} multiline />
          <AutoField name="antecedents.q3.important" />
          <AutoField name="antecedents.q3.value" />
          </div>
          <div style={styles.field}>   
          <AutoField name="antecedents.q4.text" label={'Gynécologiques/obstétriques '} multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="antecedents.q6.text" label={'Antécédents familiaux'} helperText="parents, fratrie, grand-parents, etc" multiline />
          <AutoField name="antecedents.q6.important" />
          <AutoField name="antecedents.q6.value" />
          </div>
          <div style={styles.field}>   
          <AutoField name="antecedents.q7.text" label={'Allergies'}  helperText="présence, réaction"  multiline />
        ...
        <Typography variant="headline" color={"secondary"} gutterBottom>
          ...
          <div style={styles.field}>
          <AutoField name="histlong.q2.text" label={'Petite enfance'} multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="histlong.q8.text" label={'Divorces, décès, maladie physique, trauma, abus sexuels'} multiline />
    ...
    case 2:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <AutoField
            name="lifeContext.q1.important"
          
          />
          <AutoField
            name="lifeContext.q1.value"
          ...
          />     
            <AutoField
            name="lifeContext.q2.important"
          
          />
          <AutoField
            name="lifeContext.q2.value"
    ...
    case 9:
      ...
      return (
       ...
       Signes vitaux
          ...
          <br/>
          <div style={styles.field}>
          <AutoField name="mentalExam.q3.text" label={'Comportement'} multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="mentalExam.q5.text" label={'Non-verbal'} multiline />
          ...
          <br/>
          <div style={styles.field}>   
          <AutoField name="mentalExam.q6.text" label={'Degré de coopération'} multiline />
          ...
          <br/>
          <div style={styles.field}>
          <AutoField name="mentalExam.q7.text" label={'Disposition et attitude'}  multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="mentalExam.q11.text" label={'Forme de la pensée'} multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="mentalExam.q13.text" label={'Sensorium'} multiline />
          <AutoField name="mentalExam.q13.important" />
          <AutoField name="mentalExam.q13.value" />
         
          </div>
          <div style={styles.field}>
          <AutoField name="mentalExam.q14.text" label={'Attention'}  multiline />
          <AutoField name="mentalExam.q14.important" />
          <AutoField name="mentalExam.q14.value" />
         
          </div>
          <div style={styles.field}>
          <AutoField name="mentalExam.q15.text" label={'Orientation'}  multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="mentalExam.q17.text" label={'Habileté constructionnelle'} multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="mentalExam.q19.text" label={'Pratique'} multiline />
