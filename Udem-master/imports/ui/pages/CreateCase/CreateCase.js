    ...
    return (
      <div className="CreateCase" className={classes.root}>
        ...
        <AutoForm
          schema={Cases.schema}
          onSubmit={doc => {
            Meteor.call("cases.insert", doc, error => {
              if (error) {
          ...
          <MobileStepper
            ...
            nextButton={
              <Button
                ...
                disabled={this.state.activeStep === 10}
              >
                Suivant
                {theme.direction === "rtl" ? (
                  <KeyboardArrowLeft />
    ...
    case 2:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <AutoField
            name="medication.listOfMeds.text"
            label={"Liste de médicaments"}
            multiline
          />
          <AutoField
            name="medication.recentChanges.text"
            label={"Changement récents"}
            multiline
          />
          <br />
          <Typography variant="headline" color={"secondary"} gutterBottom>
          ...
          <AutoField
            name="lifeContext.partner.text"
            label={"Partenaire"}
            multiline
          />
          <AutoField
            name="lifeContext.environment.text"
            label={"Milieu de vie"}
            multiline
          />
          <AutoField
            name="lifeContext.stressLevel.text"
            label={"Niveau de stress"}
            multiline
          />
          <AutoField
            name="lifeContext.activities.text"
            label={"Activités et loisirs"}
            multiline
          />
          <AutoField
            name="lifeContext.travels.text"
    ...
    case 3:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <AutoField
            name="lifeHabits.alcohol.text"
            label={"Alcool"}
            multiline
          />
          <AutoField name="lifeHabits.drugs.text" label={"Drogues"} multiline />
          <AutoField
            name="lifeHabits.coffee.text"
            label={"Caféine ou stimulants"}
            multiline
          />
          <AutoField
            name="lifeHabits.physAct.text"
            label={"Activité physique"}
            multiline
          />
          <AutoField
            name="lifeHabits.foodHabits.text"
            label={"Alimentation"}
            multiline
          />
          <AutoField
            name="lifeHabits.sexuality.text"
            label={"Sexualité"}
            multiline
          />
    ...
    case 4:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <AutoField
            name="currentHist.historic.text"
          ...
          <AutoField name="currentHist.r.one.text" label={"Région"} multiline />
          <AutoField
    ...
    case 5:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div
            className={"uniforms-symptom-field"}
            styles={styles.symptomField}
          >
            <AutoField name="generalSymp.one.text" label={"Fièvre"} />
            <AutoField
              name="generalSymp.one.important"
              label={"Question importante"}
            />
            <AutoField
              name="generalSymp.one.presence"
          ...
          <div
            ...
            styles={styles.symptomField}
          >
            <AutoField name="generalSymp.two.text" label={"Perte d'appétit"} />
            <AutoField
              name="generalSymp.two.important"
              label={"Question importante"}
            />
            <AutoField
              name="generalSymp.two.presence"
              label={"Symptôme présent"}
            />
          </div>
          <div
          ...
          >
            <AutoField
              name="generalSymp.three.text"
              label={"Diaphorèse nocture"}
            />
            <AutoField
              name="generalSymp.three.important"
              label={"Question importante"}
            />
            <AutoField
              name="generalSymp.three.presence"
              label={"Symptôme présent"}
            />
          </div>
          <div
          ...
          >
            ...
            <AutoField
              name="generalSymp.four.important"
              label={"Question importante"}
            />
            <AutoField
              name="generalSymp.four.presence"
              label={"Symptôme présent"}
            />
          </div>
          <div
          ...
          >
            <AutoField
              name="generalSymp.revue.text"
              label={"Revue des systemes"}
            />
            <AutoField
              name="generalSymp.revue.important"
              label={"Question importante"}
            />
            <AutoField
              name="generalSymp.revue.presence"
              label={"Symptôme présent"}
            />
          </div>
          ...
          <div
            className={"uniforms-otherSystem-field"}
            styles={styles.otherSystemField}
          >
    ...
    case 7:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <Typography variant="body1" color={"secondary"} gutterBottom>
            {" "}
            2 questions pertinentes qui pourraient se retrouver dans un cas
            d’ÉCOS
          </Typography>
