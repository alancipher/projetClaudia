...
import Ophtalmo from "../../../api/Externats/Schemas/Ophtalmo";
  ...
  render() {
    ...
    return (
      <div className="CreateCase" className={classes.root}>
        ...
        >
          {" "}
          Créer un cas d'externat : Ophtalmologie
        </Typography>
        <AutoForm
          schema={Ophtalmo}
          onSubmit={doc => {
            ...
            console.log(doc);
            Meteor.call("externats.insert", doc, "ophtalmologie", error => {
              if (error) {
    ...
    case 2:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="medication.q4.text"
              label={"Produits de santé naturels"}
              multiline
            />
            <AutoField
              name="medication.q4.important"

            />
            <AutoField
              name="medication.q4.value"
    ...
    case 11:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField name="vitalsExam.q1.text" label={'Température'} multiline />
            <AutoField name="vitalsExam.q1.important" />
            <AutoField name="vitalsExam.q1.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="vitalsExam.q2.text" label={'Fréq. cardiaque'} multiline />
            <AutoField name="vitalsExam.q2.important" />
            <AutoField name="vitalsExam.q2.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="vitalsExam.q3.text" label={'Fréq. respiratoire'} multiline />
            <AutoField name="vitalsExam.q3.important" />
            <AutoField name="vitalsExam.q3.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="vitalsExam.q4.text" label={'Tension artérielle'} multiline />
            <AutoField name="vitalsExam.q4.important" />
            <AutoField name="vitalsExam.q4.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="vitalsExam.q5.text" label={'Saturation'} multiline />
            <AutoField name="vitalsExam.q5.important" />
            <AutoField name="vitalsExam.q5.value" />
          ...
          <div style={styles.field}>
            <AutoField name="physicalExam.q1.text" label={'Acuité visuelle'} multiline />
            <AutoField name="physicalExam.q1.important" />
            <AutoField name="physicalExam.q1.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="physicalExam.q2.text" label={'Champs visuels'} multiline />
          ...
          <br />
          <div style={styles.field}>
            <AutoField name="physicalExam.q3.text" label={'Pupilles'} multiline />
          ...
          <div style={styles.field}>
            <AutoField name="physicalExam.q4.text" label={'Mouvements extra-oculaire'} multiline />
            <AutoField name="physicalExam.q4.important" />
            <AutoField name="physicalExam.q4.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="physicalExam.q5.text" label={'Pression oculaire'} multiline />
          ...
          <br />
          <div style={styles.field}>
            <AutoField name="physicalExam.q6.text" label={'Paupières'} multiline />
          ...
          <br />
          <div style={styles.field}>
            <AutoField name="physicalExam.q7.text" label={'Cornée'} multiline />
            <AutoField name="physicalExam.q7.important" />
            <AutoField name="physicalExam.q7.value" />

          </div>
          <br />
          <div style={styles.field}>
            <AutoField name="physicalExam.q8.text" label={'Conjonctive'} multiline />
            <AutoField name="physicalExam.q8.important" />
            <AutoField name="physicalExam.q8.value" />

          </div>
       
          <div style={styles.field}>
            <AutoField name="physicalExam.q9.text" label={'Chambre antérieure'} multiline />
            <AutoField name="physicalExam.q9.important" />
            <AutoField name="physicalExam.q9.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="physicalExam.q10.text" label={'Iris'} multiline />
            <AutoField name="physicalExam.q10.important" />
            <AutoField name="physicalExam.q10.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="physicalExam.q11.text" label={'Fundus'} multiline />
            <AutoField name="physicalExam.q11.important" />
            <AutoField name="physicalExam.q11.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="physicalExam.q12.text" label={'Macula'} multiline />
            <AutoField name="physicalExam.q12.important" />
            <AutoField name="physicalExam.q12.value" />

          </div>
        
          <div style={styles.field}>
            <AutoField name="physicalExam.q13.text" label={'Humeur vitrée'} multiline />
            <AutoField name="physicalExam.q13.important" />
            <AutoField name="physicalExam.q13.value" />

          </div>
          <div style={styles.field}>
            <AutoField name="physicalExam.q14.text" label={'Nerf optique'} multiline />
            <AutoField name="physicalExam.q14.important" />
            <AutoField name="physicalExam.q14.value" />
