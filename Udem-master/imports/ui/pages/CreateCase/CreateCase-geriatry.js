  ...
  render() {
    ...
    return (
      <div className="CreateCase" className={classes.root}>
        ...
        >
          {" "}
          Créer un cas d'externat : Gériatrie
        </Typography>
        <AutoForm
          schema={Geriatry}
          onSubmit={doc => {
            ...
            console.log(doc);
            Meteor.call("externatsGeriatry.insert", doc,"Gériatrie", error => {
              if (error) {
    ...
    case 2:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>   
          <AutoField name="socialHist.q1.text" label={"Nom du médecin de famille"} multiline />
          <AutoField
            name="socialHist.q1.important"
          
          />
          <AutoField
            name="socialHist.q1.value"
          ...
          />     
            <AutoField
            name="socialHist.q2.important"
          
          />
          <AutoField
            name="socialHist.q2.value"
          ...
          />     
            <AutoField
            name="socialHist.q3.important"
          
          />
          <AutoField
            name="socialHist.q3.value"
           
          />
           </div>
           <div style={styles.field}>   
          <AutoField name="socialHist.q4.text" label={"Services à domicile (infirmiers, aidants, service alimentaire..."} multiline />
          <AutoField
            name="socialHist.q4.important"
          
          />
          <AutoField
            name="socialHist.q4.value"
          ...
          />     
            <AutoField
            name="socialHist.q5.important"
          
          />
          <AutoField
            name="socialHist.q5.value"
          ...
          <div style={styles.field}>
          <AutoField name="domestic.q1.text" label={'Hygiène et apparence'} multiline />
          ...
          <div style={styles.field}>   
          <AutoField name="domestic.q4.text" label={'Contrôle des sphincters'} multiline />
          <AutoField name="domestic.q4.important" />
          <AutoField name="domestic.q4.value" />
          </div>
          <div style={styles.field}>   
          <AutoField name="domestic.q5.text" label={'Déglutition'} multiline />
    ...
    case 9:
      ...
      return (
        ...
        Plan
          ...
          <div style={styles.field}>   
          <AutoField name="plan.q1.text" label={"Investigations supplémentaires"} multiline />
          <AutoField
            name="plan.q1.important"
          ...
          />
           ...
           <div style={styles.field}>   
          <AutoField name="plan.q4.text" label={"Traitements médicamenteux"} multiline />
          <AutoField
            name="plan.q4.important"
