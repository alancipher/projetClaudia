...
import Psychos from "../../../api/Externats/Schemas/Psychos";
    ...
    if (loading) {
      ...
      return (
        <div className="EditCase" className={classes.root}>
          ...
          >
            {" "}
           Modifier un cas d'externat : Psychiatrie
          </Typography>
          <AutoForm
            schema={Psychos}
            model={sessionCase}
            onSubmit={doc => {
              ...
              console.log(doc);
              Meteor.call("externatsPsychiatry.update", doc, "psychiatrie", error => {
                if (error) {
                  Bert.alert(error.reason, "danger"); 
                } else {
                  // TODO use better alerts
                  swal("Votre cas clinique à été sauvegardé !", {
                    icon: "success"
                  });
            ...
            <MobileStepper
              ...
              nextButton={
                <Button
                  ...
                  disabled={this.state.activeStep === 12}
                >
                  Suivant
                  {theme.direction === "rtl" ? (
                    <KeyboardArrowLeft />
      ...
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="antecedents.q1.text"
              label={"Personnels médicaux"}
              helperText="Ne pas utiliser d'acronymes"
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField name="antecedents.q5.text" label={"Vaccins"} multiline />
            <AutoField name="antecedents.q5.important" />
            <AutoField name="antecedents.q5.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="antecedents.q6.text"
              label={"Antécédents familiaux"}
              helperText="parents, fratrie, grand-parents, etc"
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField
              name="antecedents.q7.text"
              label={"Allergies"}
              helperText="présence, réaction"
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField name="histlong.q1.text" label={"Naissance"} multiline />
            <AutoField name="histlong.q1.important" />
            <AutoField name="histlong.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="histlong.q2.text"
              label={"Petite enfance"}
              multiline
            />
            <AutoField name="histlong.q2.important" />
            <AutoField name="histlong.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="histlong.q3.text" label={"Primaire"} multiline />
            <AutoField name="histlong.q3.important" />
            <AutoField name="histlong.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="histlong.q4.text" label={"Secondaire"} multiline />
            <AutoField name="histlong.q4.important" />
            <AutoField name="histlong.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="histlong.q5.text" label={"Études"} multiline />
            <AutoField name="histlong.q5.important" />
            <AutoField name="histlong.q5.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="histlong.q6.text" label={"Travail"} multiline />
            <AutoField name="histlong.q6.important" />
            <AutoField name="histlong.q6.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="histlong.q7.text" label={"Relation"} multiline />
            <AutoField name="histlong.q7.important" />
            <AutoField name="histlong.q7.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="histlong.q8.text"
              label={"Divorces, décès, maladie physique, trauma, abus sexuels"}
              multiline
            />
            <AutoField name="histlong.q8.important" />
            <AutoField name="histlong.q8.value" />
          </div>
        </Grid>
      );
    case 2:
        ...
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="medication.q1.important" />
            <AutoField name="medication.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="medication.q2.important" />
            <AutoField name="medication.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="medication.q3.important" />
            <AutoField name="medication.q3.value" />
          </div>
          ...
          <div style={styles.field}>
            ...
            <AutoField name="lifeHabits.q1.important" />
            <AutoField name="lifeHabits.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="lifeHabits.q2.text" label={"Alcool"} multiline />
            <AutoField name="lifeHabits.q2.important" />
            <AutoField name="lifeHabits.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="lifeHabits.q3.text" label={"Drogues"} multiline />
            <AutoField name="lifeHabits.q3.important" />
            <AutoField name="lifeHabits.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="lifeHabits.q4.text"
              label={"Caféines/stimulants"}
              multiline
            />
            <AutoField name="lifeHabits.q4.important" />
            <AutoField name="lifeHabits.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="lifeHabits.q5.important" />
            <AutoField name="lifeHabits.q5.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="lifeHabits.q6.important" />
            <AutoField name="lifeHabits.q6.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="lifeHabits.q7.important" />
            <AutoField name="lifeHabits.q7.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="lifeHabits.q8.text" label={"Sommeil"} multiline />
            <AutoField name="lifeHabits.q8.important" />
            <AutoField name="lifeHabits.q8.value" />
          </div>
          <br />
          ...
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="lifeContext.q3.important" />
            <AutoField name="lifeContext.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="lifeContext.q4.text"
              label={"Niveau de stress"}
              multiline
            />
            <AutoField name="lifeContext.q4.important" />
            <AutoField name="lifeContext.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="lifeContext.q5.important" />
            <AutoField name="lifeContext.q5.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="lifeContext.q6.important" />
            <AutoField name="lifeContext.q6.value" />
          </div>
          ...
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.open.important" />
            <AutoField name="currentHist.open.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.p.one.important" />
            <AutoField name="currentHist.p.one.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.p.two.important" />
            <AutoField name="currentHist.p.two.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.q.one.important" />
            <AutoField name="currentHist.q.one.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.q.two.important" />
            <AutoField name="currentHist.q.two.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.r.one.important" />
            <AutoField name="currentHist.r.one.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.r.two.important" />
            <AutoField name="currentHist.r.two.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.s.one.important" />
            <AutoField name="currentHist.s.one.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.t.one.important" />
            <AutoField name="currentHist.t.one.value" />
          </div>
        </Grid>
      );
    case 3:
      return (
        <Grid item xs={12} sm={12}>
          <Typography variant="headline" color={"secondary"} gutterBottom>
            Revue des systèmes : Choisir les systèmes qui s’applique au cas
            clinique que vous créez. Si oui, cochez et spécifiez.
          </Typography>
          <Typography variant="headline" color={"secondary"} gutterBottom>
            Symptômes généraux
          </Typography>
    ...
    case 5:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="sysNeuro.q1.text"
              label={"Dominance manuelle"}
              helperText="D ou G, même si ce n’est pas un symptôme, c’est utile à savoir"
              multiline
            />
    ...
    case 6:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="sysRespi.q1.text"
              label={"Consommation de tabac"}
              helperText="nombre de paquets/année"
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField
              name="sysRespi.q7.text"
              label={"Exposition industrielle ou autre"}
              helperText="amiantose, silicose"
              multiline
            />
    ...
    case 11:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField name="mentalExam.q1.text" label={"Hygiène"} multiline />
            <AutoField name="mentalExam.q1.important" />
            <AutoField name="mentalExam.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="mentalExam.q2.text" label={"Posture"} multiline />
            <AutoField name="mentalExam.q2.important" />
            <AutoField name="mentalExam.q2.value" />
          </div>

          <br />
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q3.text"
              label={"Comportement"}
              multiline
            />
            <AutoField name="mentalExam.q3.important" />
            <AutoField name="mentalExam.q3.value" />
          </div>
          <Typography variant="body1" color={"secondary"} gutterBottom>
            Langage
          </Typography>
          <div style={styles.field}>
            <AutoField name="mentalExam.q4.text" label={"Verbale"} multiline />
            <AutoField name="mentalExam.q4.important" />
            <AutoField name="mentalExam.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q5.text"
              label={"Non-verbal"}
              multiline
            />
            <AutoField name="mentalExam.q5.important" />
            <AutoField name="mentalExam.q5.value" />
          </div>
          <br />
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q6.text"
              label={"Degré de coopération"}
              multiline
            />
            <AutoField name="mentalExam.q6.important" />
            <AutoField name="mentalExam.q6.value" />
          </div>
          <br />
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q7.text"
              label={"Disposition et attitude"}
              multiline
            />
            <AutoField name="mentalExam.q7.important" />
            <AutoField name="mentalExam.q7.value" />
          </div>
          <br />
          <div style={styles.field}>
            <AutoField name="mentalExam.q8.text" label={"Affect"} multiline />
            <AutoField name="mentalExam.q8.important" />
            <AutoField name="mentalExam.q8.value" />
          </div>
          <Typography variant="body1" color={"secondary"} gutterBottom>
            Pensée
          </Typography>
          ...
          <div style={styles.field}>
            <AutoField name="mentalExam.q9.text" label={"Cours"} multiline />
            <AutoField name="mentalExam.q9.important" />
            <AutoField name="mentalExam.q9.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="mentalExam.q10.text" label={"Logique"} multiline />
            <AutoField name="mentalExam.q10.important" />
            <AutoField name="mentalExam.q10.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q11.text"
              label={"Forme de la pensée"}
              multiline
            />
            <AutoField name="mentalExam.q11.important" />
            <AutoField name="mentalExam.q11.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="mentalExam.q12.text" label={"Contenu"} multiline />
            <AutoField name="mentalExam.q12.important" />
            <AutoField name="mentalExam.q12.value" />
          </div>
          <Typography variant="body1" color={"secondary"} gutterBottom>
          ...
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q13.text"
              label={"Sensorium"}
              multiline
            />
            <AutoField name="mentalExam.q13.important" />
            <AutoField name="mentalExam.q13.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q14.text"
              label={"Attention"}
              multiline
            />
            <AutoField name="mentalExam.q14.important" />
            <AutoField name="mentalExam.q14.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q15.text"
              label={"Orientation"}
              multiline
            />
            <AutoField name="mentalExam.q15.important" />
            <AutoField name="mentalExam.q15.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="mentalExam.q16.text" label={"Mémoire"} multiline />
            <AutoField name="mentalExam.q16.important" />
            <AutoField name="mentalExam.q16.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q17.text"
              label={"Habileté constructionnelle"}
              multiline
            />
            <AutoField name="mentalExam.q17.important" />
            <AutoField name="mentalExam.q17.value" />
          </div>

          <Typography variant="body2">Jugement</Typography>
          <div style={styles.field}>
            <AutoField name="mentalExam.q18.text" label={"Social"} multiline />
            <AutoField name="mentalExam.q18.important" />
            <AutoField name="mentalExam.q18.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="mentalExam.q19.text"
              label={"Pratique"}
              multiline
            />
            <AutoField name="mentalExam.q19.important" />
            <AutoField name="mentalExam.q19.value" />
          </div>
        </Grid>
      );
    case 12:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="additional.q3.question"
              label={"Question pertinente"}
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField
              name="additional.q4.question"
              label={"Autre question pertinente"}
              multiline
            />
...
export default withTracker(({ match }) => {
  ...
  const subscription = Meteor.subscribe("externatsPsycho.view.edit", documentId);
