    ...
    if (loading) {
      ...
      return (
        <div className="EditCase" className={classes.root}>
          ...
          >
            {" "}
           Modifier un cas d'externat : Chirurgie
          </Typography>
          <AutoForm
            schema={Chirurgies}
            model={sessionCase}
            onSubmit={doc => {
              ...
              console.log(doc);
              Meteor.call("externatsSurgery.update", doc, "chirurgie", error => {
                if (error) {
        ...
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              ...
              label={"Salle d’opération prévue quand et pourquoi"}
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField
              name="antecedents.q8.text"
              label={"Personnels médicaux (les pertinents)"}
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField
              name="antecedents.q9.text"
              label={"Gynecologique/obstétriques"}
              multiline
            />
          ...
          <div style={styles.field}>
            <AutoField
              name="antecedents.q10.text"
              label={
                "Antécédents familiaux (lorsque pertinent; par exemple si ATCD de néoplasie)"
              }
              multiline
            />
...
export default withTracker(({ match }) => {
  ...
  const subscription = Meteor.subscribe("externatsSurgery.view.edit", documentId);
