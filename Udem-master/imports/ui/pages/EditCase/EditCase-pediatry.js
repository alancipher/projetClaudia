...
import Pediatry from "../../../api/Externats/Schemas/Pediatry";
...
import Surgeries from "../../../api/Externats/Schemas/Pediatry";
...
class EditCase extends React.Component {
  ...
  render() {
    const { classes, theme ,sessionCase,history, loading,...props} = this.props;
    ...
    return (
      <div className="EditCase" className={classes.root}>
        ...
        >
          {" "}
         Modifier un cas d'externat : Pédiatrie
        </Typography>
        <AutoForm
          schema={Pediatry}
          model={sessionCase}
          onSubmit={doc => {
            ...
            console.log(doc);
            Meteor.call("externats.update", doc, "pediatrie", error => {
              if (error) {
    ...
    case 1:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField name="antecedents.q2.text" label={'Grossesse'} multiline />
            <AutoField name="antecedents.q2.important" />
            <AutoField name="antecedents.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="antecedents.q3.text" label={'Chirurgicaux'} multiline />
            <AutoField name="antecedents.q3.important" />
            <AutoField name="antecedents.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="antecedents.q4.text" label={'Psychiatriques/psychologiques'} multiline />
            <AutoField name="antecedents.q4.important" />
            <AutoField name="antecedents.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="antecedents.q5.text" label={'Gynécologiques/obstétriques '} multiline />
            <AutoField name="antecedents.q5.important" />
            <AutoField name="antecedents.q5.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="antecedents.q6.text" label={'Vaccins'} multiline />
            <AutoField name="antecedents.q6.important" />
            <AutoField name="antecedents.q6.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="antecedents.q7.text" label={'Antécédents familiaux'} helperText="parents, fratrie, grand-parents, etc" multiline />
            <AutoField name="antecedents.q7.important" />
            <AutoField name="antecedents.q7.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="antecedents.q8.text" label={'Allergies'} helperText="présence, réaction" multiline />
    ...
    case 2:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField name="socialHist.q1.text" label={"Milieu de vie"} multiline />
            <AutoField name="socialHist.q1.important" />
            <AutoField name="socialHist.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="socialHist.q2.text" label={"École"} multiline />
            <AutoField name="socialHist.q2.important" />
            <AutoField name="socialHist.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="socialHist.q3.text" label={"Activités"} multiline />
            <AutoField name="socialHist.q3.important" />
            <AutoField name="socialHist.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="socialHist.q4.text" label={"Drogues"} multiline />
            <AutoField name="socialHist.q4.important" />
            <AutoField name="socialHist.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="socialHist.q5.text" label={"Diète"} multiline />
            <AutoField name="socialHist.q5.important" />
            <AutoField name="socialHist.q5.value" />
          </div>

          <div style={styles.field}>
            <AutoField name="socialHist.q6.text" label={"Sexualité"} multiline />
            <AutoField name="socialHist.q6.important" />
            <AutoField name="socialHist.q6.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="socialHist.q7.text" label={"Iéation suicidaire / dépression"} multiline />
            <AutoField name="socialHist.q7.important" />
            <AutoField name="socialHist.q7.value" />
          </div>
