...
import Geriatry from "../../../api/Externats/Schemas/Geriatry";
...
import Surgeries from "../../../api/Externats/Schemas/Geriatry";
...
class EditCase extends React.Component {
  ...
  render() {
    const { history, sessionCase, classes, theme, loading,...props } = this.props;
...
return(<Loading {...props}/>);
    ...
    return (
      <div className="EditCase" className={classes.root}>
        ...
        >
          {" "}
         Modifier un cas d'externat : Gériatrie
        </Typography>
        <AutoForm
          schema={Geriatry}
          model={sessionCase}
          onSubmit={doc => {
            ...
            console.log(doc);
            Meteor.call("externatsGeriatry.update", doc, "geriatrie", error => {
              if (error) {
    ...
    case 2:
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="socialHist.q1.text"
              label={"Nom du médecin de famille"}
              multiline
            />
            <AutoField name="socialHist.q1.important" />
            <AutoField name="socialHist.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="socialHist.q2.text"
              label={"Milieux de vie (maison, appartement, résidence…)"}
              multiline
            />
            <AutoField name="socialHist.q2.important" />
            <AutoField name="socialHist.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="socialHist.q3.text"
              label={"Personne ressource / Mandataire / Proches aidants"}
              multiline
            />
            <AutoField name="socialHist.q3.important" />
            <AutoField name="socialHist.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="socialHist.q4.text"
              label={
                "Services à domicile (infirmiers, aidants, service alimentaire..."
              }
              multiline
            />
            <AutoField name="socialHist.q4.important" />
            <AutoField name="socialHist.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="socialHist.q5.text"
              label={"Emplois actifs ou anciens"}
              multiline
            />
            <AutoField name="socialHist.q5.important" />
            <AutoField name="socialHist.q5.value" />
          </div>
          ...
          <div style={styles.field}>
            <AutoField
              name="domestic.q1.text"
              label={"Hygiène et apparence"}
              multiline
            />
            <AutoField name="domestic.q1.important" />
            <AutoField name="domestic.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="domestic.q2.text" label={"Habillage"} multiline />
            <AutoField name="domestic.q2.important" />
            <AutoField name="domestic.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="domestic.q3.text" label={"Se nourrir"} multiline />
            <AutoField name="domestic.q3.important" />
            <AutoField name="domestic.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="domestic.q4.text"
              label={"Contrôle des sphincters"}
              multiline
            />
            <AutoField name="domestic.q4.important" />
            <AutoField name="domestic.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="domestic.q5.text"
              label={"Déglutition"}
              multiline
            />
            <AutoField name="domestic.q5.important" />
            <AutoField name="domestic.q5.value" />
          </div>
          ...
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.t.two.important" />
            <AutoField name="currentHist.t.two.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              ...
              multiline
            />
            <AutoField name="currentHist.t.three.important" />
            <AutoField name="currentHist.t.three.value" />
          </div>
          <div style={styles.field}>
            <AutoField name="currentHist.t.four.text" label={"Fin"} multiline />
            <AutoField name="currentHist.t.four.important" />
      ...
      return (
        <Grid item xs={12} sm={12}>
          ...
          <div style={styles.field}>
            <AutoField
              name="plan.q1.text"
              label={"Investigations supplémentaires"}
              multiline
            />
            <AutoField name="plan.q1.important" />
            <AutoField name="plan.q1.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q2.text"
              label={"Consultations d'autres spécialités"}
              multiline
            />
            <AutoField name="plan.q2.important" />
            <AutoField name="plan.q2.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q3.text"
              label={"Consultations d'autres professionnels"}
              multiline
            />
            <AutoField name="plan.q3.important" />
            <AutoField name="plan.q3.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q4.text"
              ...
              multiline
            />
            <AutoField name="plan.q4.important" />
            <AutoField name="plan.q4.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q5.text"
              label={"Approche comportementale, cognitive, psychodynamique"}
              multiline
            />
            <AutoField name="plan.q5.important" />
            <AutoField name="plan.q5.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q6.text"
              label={"Thérapie de milieu"}
              multiline
            />
            <AutoField name="plan.q6.important" />
            <AutoField name="plan.q6.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q7.text"
              label={"Thérapie de soutien"}
              multiline
            />
            <AutoField name="plan.q7.important" />
            <AutoField name="plan.q7.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q8.text"
              label={"Information à donner au patient et à ses proches"}
              multiline
            />
            <AutoField name="plan.q8.important" />
            <AutoField name="plan.q8.value" />
          </div>
          <div style={styles.field}>
            <AutoField
              name="plan.q9.text"
              label={"Maladie, traitements, médicaments"}
              multiline
            />
            <AutoField name="plan.q9.important" />
            <AutoField name="plan.q9.value" />
          </div>
          <Typography variant="body1" color={"secondary"} gutterBottom>
...
export default withTracker(({ match }) => {
  ...
  const subscription = Meteor.subscribe("externatsGeriatry.view.edit", documentId);
