...
import ReasonSearch from './ReasonSearch';
...
class Search extends React.Component {
  ...
  componentWillMount = () => {
    ...
    // this.props.onSetSearchArray(this.props.searchArray);
    this.props.onSetUserCases(this.props.cases);
  };
  componentDidMount = () => {
    console.log("component did mount");
    // this.setState({
    //   reasonArray: this.generateReasonArray(this.props.cases),
    //   systemeArray: this.generateSystemeArray(this.props.cases),
    //   nameArray: this.generateNameArray(this.props.cases),
    // });
  };
  ...
  render() {
    ...
    return (
      <div className={classes.grid}>            
          <ReasonSearch label="Rechercher par raison de consultation" className={(classes.textField, classes.search)} nameArray={reasonArray} {...this.props} />       
      </div>
