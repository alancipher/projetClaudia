            ...
            <Button
              ...
              onClick={e => {
                ...
                this.props.history.push(
                  "/editCase-psychiatrie/" + this.props.sessionCase._id
                );
              }}
            >
              Modifier le cas
                ...
                onClick={() => {
                  swal(
                    ...
                    if (value == "oui") {
                      ...
                      Meteor.call("externatsPsychiatry.unpost", caseDoc, error => {
                        if (error) {
                ...
                onClick={() => {
                  swal(
                    ...
                    if (value == "oui") {
                      ...
                      Meteor.call("externatsPsychiatry.post", caseDoc, (error, result) => {
                        if (error) {
                          swal(error.reason, { icon: "error" });
                        } else {
...
export default withTracker(({ match }) => {
  ...
  const subscription = Meteor.subscribe("externatsPsycho.view", documentId);
