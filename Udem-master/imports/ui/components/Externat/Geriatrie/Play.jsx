...
class Play extends React.Component {
  ...
  caculateResult() {
    ...
    Meteor.call("externats-documents.insert", document, (error, documentId) => {
      if (error) {
        ...
        this.props.history.push(`/externat-revue/gériatrie/${documentId}`);
      }
    });
  }
  ...
  answering2(category, subcategory, question) {
    var theCase = this.state.sessionCase;
    const currentAnswer = this.state.sessionCase[category][subcategory][
      question
    ].done;
      ...
      <div className={styles.root}>
        ...
        >
          ...
          <ExpansionPanelDetails>
            <List
              className={"fullwidth"}
              disabled={this.props.clockState != "STARTED"}
              component="nav"
          ...
          <ExpansionPanelDetails>
            ...
            >
              ...
              >
                ...
                <ListItemText
                  primary="Psychiatriques/psychologiques"
          ...
          <ExpansionPanelDetails>
            ...
            >
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("lifeHabits", "q4");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.lifeHabits.q4.done}
                  disableRipple
                />
                <ListItemText
                  primary="Caféines/stimulants"
                  secondary={sessionCase.lifeHabits.q4.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.lifeHabits.q4.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("lifeHabits", "q5");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.lifeHabits.q5.done}
                  disableRipple
                />
                <ListItemText
                  primary="Activité physique"
                  secondary={sessionCase.lifeHabits.q5.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.lifeHabits.q5.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("lifeHabits", "q6");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.lifeHabits.q6.done}
                  disableRipple
                />
                <ListItemText
                  primary="Alimentation"
                  secondary={sessionCase.lifeHabits.q6.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.lifeHabits.q6.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("lifeHabits", "q7");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.lifeHabits.q7.done}
                  disableRipple
                />
                <ListItemText
                  primary="Sexualité"
                  secondary={sessionCase.lifeHabits.q7.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.lifeHabits.q7.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("lifeHabits", "q8");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.lifeHabits.q8.done}
                  disableRipple
                />
                <ListItemText
                  primary="Sommeil"
                  secondary={sessionCase.lifeHabits.q8.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.lifeHabits.q8.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
          ...
          <ExpansionPanelDetails>
            ...
            >
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("socialHist", "q1");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.socialHist.q1.done}
                  disableRipple
                />
                <ListItemText
                  primary="Nom du médecin de famille"
                  secondary={sessionCase.socialHist.q1.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.socialHist.q1.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("socialHist", "q2");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.socialHist.q2.done}
                  disableRipple
                />
                <ListItemText
                  primary="Milieux de vie"
                  secondary={sessionCase.socialHist.q2.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.socialHist.q2.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("socialHist", "q3");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.socialHist.q3.done}
                  disableRipple
                />
                <ListItemText
                  primary="Personne ressource / Mandataire / Proches aidants"
                  secondary={sessionCase.socialHist.q3.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.socialHist.q3.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("socialHist", "q4");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.socialHist.q4.done}
                  disableRipple
                />
                <ListItemText
                  primary="Services à domicile"
                  secondary={sessionCase.socialHist.q4.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.socialHist.q4.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("socialHist", "q5");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.socialHist.q5.done}
                  disableRipple
                />
                <ListItemText
                  primary="Emplois actifs ou anciens"
                  secondary={sessionCase.socialHist.q5.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.socialHist.q5.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
        ...
        <ExpansionPanel
          ...
          onChange={this.handleChange("panel33")}
        >
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant={"headline"} color={"primary"}>
          ...
          <ExpansionPanelDetails>
            ...
            >
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q1");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q1.done}
                  disableRipple
                />
                <ListItemText
                  primary="Ménage"
                  secondary={sessionCase.domestic.q1.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q1.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q2");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q2.done}
                  disableRipple
                />
                <ListItemText
                  primary="Lavage"
                  secondary={sessionCase.domestic.q2.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q2.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q3");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q3.done}
                  disableRipple
                />
                <ListItemText
                  primary="Utilisation du téléphone"
                  secondary={sessionCase.domestic.q3.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q3.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q4");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q4.done}
                  disableRipple
                />
                <ListItemText
                  primary="Préparation des repas"
                  secondary={sessionCase.domestic.q4.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q4.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q5");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q5.done}
                  disableRipple
                />
                <ListItemText
                  primary="Courses"
                  secondary={sessionCase.domestic.q5.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q5.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q6");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q6.done}
                  disableRipple
                />
                <ListItemText
                  primary="Gestion financière"
                  secondary={sessionCase.domestic.q6.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q6.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q7");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q7.done}
                  disableRipple
                />
                <ListItemText
                  primary="Auto-médication"
                  secondary={sessionCase.domestic.q7.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q7.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("domestic", "q8");
                }}
                button
              >
                <Checkbox
                  checked={sessionCase.domestic.q8.done}
                  disableRipple
                />
                <ListItemText
                  primary="Transport (autre que la marche)"
                  secondary={sessionCase.domestic.q8.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.domestic.q8.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
        ...
        <ExpansionPanel
          expanded={expanded === "panel333"}
          onChange={this.handleChange("panel333")}
        >
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant={"headline"} color={"primary"}>
              7.ACTIVITÉS de la VIE QUOTIDIENNE
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <List
            ...
            >
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("daily", "q1");
                }}
                button
              >
                <Checkbox checked={sessionCase.daily.q1.done} disableRipple />
                <ListItemText
                  primary="Hygiène et apparence"
                  secondary={sessionCase.daily.q1.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.daily.q1.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("daily", "q2");
                }}
                button
              >
                <Checkbox checked={sessionCase.daily.q2.done} disableRipple />
                <ListItemText
                  primary="Habillage"
                  secondary={sessionCase.daily.q2.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.daily.q2.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("daily", "q3");
                }}
                button
              >
                <Checkbox checked={sessionCase.daily.q3.done} disableRipple />
                <ListItemText
                  primary="Se nourrir"
                  secondary={sessionCase.daily.q3.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.daily.q3.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("daily", "q4");
                }}
                button
              >
                <Checkbox checked={sessionCase.daily.q4.done} disableRipple />
                <ListItemText
                  primary="Contrôle des sphincters"
                  secondary={sessionCase.daily.q4.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.daily.q4.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("daily", "q5");
                }}
                button
              >
                <Checkbox checked={sessionCase.daily.q5.done} disableRipple />
                <ListItemText
                  primary="Déglutition"
                  secondary={sessionCase.daily.q5.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.daily.q5.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <Divider />
              <ListItem disabled={this.props.clockState != "STARTED"} button>
                {/* Yeah okay Im  troll but 300$ like come on*/}

                <ListItemText
                  primary="Niveau de soins"
                  secondary={sessionCase.careLvl}
                />
                <ListItemSecondaryAction />
              </ListItem>
            </List>
        ...
        >
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant={"headline"} color={"primary"}>
              8. HISTOIRE de la MALADIE ACTUELLE
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <List
        ...
        >
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant={"headline"} color={"primary"}>
              10. SYSTÈME OTO-RHINO-LARYNGOLOGIQUE
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <List
        ...
        >
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant={"headline"} color={"primary"}>
              21. SYSTÈME TROPHIQUE (PEAU ET PHANÈRES)
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <List
        ...
        >
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant={"headline"} color={"primary"}>
              25. SIGNE VITAUX ET EXAMEN PHYSIQUE
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <List
          ...
          <ExpansionPanelDetails>
            ...
            >
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q1");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q1.done} disableRipple />
                <ListItemText
                  primary="Investigations supplémentaires"
                  secondary={sessionCase.plan.q1.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q1.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q2");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q2.done} disableRipple />
                <ListItemText
                  primary="Consultations d'autres spécialités"
                  secondary={sessionCase.plan.q2.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q2.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q3");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q3.done} disableRipple />
                <ListItemText
                  primary="Consultations d'autres professionnels"
                  secondary={sessionCase.plan.q3.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q3.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q4");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q4.done} disableRipple />
                <ListItemText
                  primary="Traitements médicamenteux"
                  secondary={sessionCase.plan.q4.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q4.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q5");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q5.done} disableRipple />
                <ListItemText
                  primary="Approche comportementale, cognitive, psychodynamique"
                  secondary={sessionCase.plan.q5.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q5.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q6");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q6.done} disableRipple />
                <ListItemText
                  primary="Thérapie de milieu"
                  secondary={sessionCase.plan.q6.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q6.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q7");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q7.done} disableRipple />
                <ListItemText
                  primary="Thérapie de soutien"
                  secondary={sessionCase.plan.q7.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q7.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q8");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q8.done} disableRipple />
                <ListItemText
                  primary="Information à donner au patient et à ses proches"
                  secondary={sessionCase.plan.q8.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q8.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
              ...
              <ListItem
                disabled={this.props.clockState != "STARTED"}
                onClick={e => {
                  this.answering1("plan", "q9");
                }}
                button
              >
                <Checkbox checked={sessionCase.plan.q9.done} disableRipple />
                <ListItemText
                  primary="Maladie, traitements, médicaments"
                  secondary={sessionCase.plan.q9.text}
                />
                <ListItemSecondaryAction>
                  {sessionCase.plan.q9.important ? (
                    <IconButton aria-label="Star">
                      <StarIcon />
                    </IconButton>
                  ) : (
