            ...
            <Button
              ...
              onClick={e => {
                ...
                this.props.history.push(
                  "/editCase-chirurgie/" + this.props.sessionCase._id
                );
              }}
            >
              Modifier le cas
                ...
                onClick={() => {
                  swal(
                    ...
                    if (value == "oui") {
                      ...
                      Meteor.call("externatsSurgery.unpost", caseDoc, error => {
                        if (error) {
                ...
                onClick={() => {
                  swal(
                    ...
                    if (value == "oui") {
                      ...
                      Meteor.call("externatsSurgery.post", caseDoc, (error, result) => {
                        if (error) {
                          swal(error.reason, { icon: "error" });
                        } else {
...
export default withTracker(({ match }) => {
  ...
  const subscription = Meteor.subscribe("externatsSurgery.view", documentId);
